...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=ClusterFilter,
        default=[ClusterFilter('1 offline'), ClusterFilter('lag 10s'), ClusterFilter('transaction_queue 1000')],
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=ClusterFilter,
        default=[ClusterFilter('no primary'), ClusterFilter('lag 30s'), ClusterFilter('transaction_queue 5000')],
